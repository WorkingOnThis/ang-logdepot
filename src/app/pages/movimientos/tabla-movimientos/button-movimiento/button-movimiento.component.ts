...
import { UsuarioService, MovimientosService } from '../../../../services/service.index';
...
@Component({
  selector: 'app-button-movimiento',
  templateUrl: './button-movimiento.component.html',
  styleUrls: ['./button-movimiento.component.css'],
})
export class ButtonMovimientoComponent implements ICellRendererAngularComp {
  ...
  desanularUsuario(id: string, rowIndex: number){
    // this._movimientosService.desanularUsuario( id )
    // .subscribe( (resp:any) => {
    //     if(resp.ok === true){
  ...
  anularUsuario(id: string, rowIndex: number){
    ...
    // this._movimientosService.anularUsuario( this.anulado )
